  ...
  return (
    <section id="impact" className="bg-white py-24 md:py-32">
      <div className="max-w-7xl mx-auto section-padding">
        ...
        {/* Global significance */}
        <div className="mt-20 bg-[#faf7f2] border-t-4 border-gold-500 grid lg:grid-cols-2 items-stretch">
          <div className="p-10 md:p-16">
            ...
            <p className="section-body">
              ...
              diversity enriches humanity, preserving the many ways communities
          ...
          <img
            ...
            alt="Snow-capped mountains and lake in the Mongolian countryside"
